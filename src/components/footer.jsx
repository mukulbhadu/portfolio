...
const Footer = () => {
  ...
  <footer class="bg-zinc-950 text-gray-300 mt-auto border-t border-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row justify-between space-y-8 md:space-y-0 text-center md:text-left">

      <div>
        <h2 class="text-white text-2xl font-semibold mb-3">Mukul</h2>
        <p class="leading-relaxed max-w-md mx-auto md:mx-0">
      ...
      <div>
        <h2 class="text-white text-2xl font-semibold mb-3 md:mr-52">Click 2 Connect</h2>

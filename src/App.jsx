...
const App = () => {
  return (
    <body>
      ...
      <div className='first flex flex-row space-x-40 bg-black border-b border-gray-900 pb-14 '>
        <div className="left   bg-black text-white max-w-1/2">
          ...
          <h1 className='text-2xl font-semibold text-amber-50 ml-48'>
        ...
        <div className="right  bg-black text-white"><img src="https://pbs.twimg.com/profile_images/1982407747640410112/Vx6vADm8_400x400.jpg" alt=" picture" className=" mt-80 rounded-full w-" />
          <div className="adddetails mt-6 ml-16">
            <span className="location">📍Sriganganagar, Rajasthan, India</span> <h3 className="hover:text-amber-50 hover:cursor-pointer mt-0.5">Mukulbhaduwork@gmail.com</h3> <h1 className="text-xl font-bold mt-4">Education</h1> <ul> <li>Engineering college Bikaner</li> <li> Btech : 2024-2028</li> <li>CSE</li> </ul>
          </div>
        </div>
      </div>
      <div className="second flex flex-row bg-black text-white pb-10 space-x-80 border-b border-gray-900 ">
        <div className="skills">
          <h2 className='text-3xl font-bold justify-center  flex my-10'>Skills</h2>
          <ul className="flex space-x-16 ml-20 ">
      ...
      <div className="third flex flex-row space-x-96 bg-black text-white pt-10 ">
        <div className="learning ml-52">
          <h1 className="text-3xl font-bold justify-center ml-32 flex ">Learning</h1>
          <ul className="ml-40 mt-20"><li className="flex flex-col  hover:scale-110 transition-transform duration-300">
        ...
        <div className="Version Control & Collaboration">
           <h2 className="text-3xl font-bold justify-center  flex ">Version Control & Collaboration</h2>
